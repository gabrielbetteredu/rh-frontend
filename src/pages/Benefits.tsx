...
const Benefits: React.FC = () => {
    ...
    const [selectedBenefit, setSelectedBenefit] = useState<Benefit | null>(
        null
    );
                ...
                prev.map((b) => {
                    if (b._id === selectedBenefit._id) {
                        ...
                        if (deductionData.benefitType === "VR") {
                            updatedBenefit.valeRefeicao.deductions.push(
                                newDeduction
                            );
                            updatedBenefit.valeRefeicao.finalAmount -=
                                deductionData.amount;
                        } else {
                            updatedBenefit.valeTransporte.deductions.push(
                                newDeduction
                            );
                            updatedBenefit.valeTransporte.finalAmount -=
                                deductionData.amount;
                        }
    ...
    const handleUploadSchedule = async () => {
        ...
        try {
            ...
            formData.append(
                "businessDays",
                scheduleData.businessDays.toString()
            );
            ...
            {statistics && (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">
                                {formatCurrency(statistics.totalVR)}
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">
                                {formatCurrency(statistics.totalVT)}
                            </div>
                        </CardContent>
                    </Card>
                                        ...
                                        <TableRow key={benefit._id}>
                                            ...
                                            <TableCell>
                                                <div className="text-sm">
                                                    ...
                                                    <div className="text-muted-foreground">
                                                        {benefit.valeTransporte
                                                            .fixedAmount > 0
                                                            ? "Valor fixo"
                                                            : `${benefit.valeTransporte.totalDays} dias`}
                                                    </div>
                                                </div>
                                            </TableCell>
                ...
                <TabsContent value="flash" className="space-y-4">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Envie benefícios aprovados para pagamento via
                                Flash
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                                    ...
                                    <Button
                                        onClick={() => {
                                            ...
                                            if (approvedBenefits.length > 0) {
                                                handleApproveBenefits(
                                                    approvedBenefits.map(
                                                        (b) => b._id
                                                    )
                                                );
                                            }
            ...
            >
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Adicione uma dedução para{" "}
                            {selectedBenefit?.employeeData?.firstName}{" "}
                            {selectedBenefit?.employeeData?.lastName}
                        </DialogDescription>
                    </DialogHeader>
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <Select
                                value={deductionData.benefitType}
                                onValueChange={(value) =>
                                    setDeductionData({
                                        ...deductionData,
                                        benefitType: value,
            ...
            >
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Faça upload do cronograma de trabalho para{" "}
                            {selectedBenefit?.employeeData?.firstName}{" "}
                            {selectedBenefit?.employeeData?.lastName}
                        </DialogDescription>
                    </DialogHeader>
